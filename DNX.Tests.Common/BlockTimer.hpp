...
namespace DNX::Tests::Common {
    ...
    constexpr BlockTimer::TimeFormat ns = BlockTimer::TimeFormat::NANOSECONDS;
    constexpr BlockTimer::TimeFormat mus = BlockTimer::TimeFormat::MICROSECONDS;
    constexpr BlockTimer::TimeFormat ms = BlockTimer::TimeFormat::MILLISECONDS;
    constexpr BlockTimer::TimeFormat s = BlockTimer::TimeFormat::SECONDS;

    constexpr BlockTimer::TimeFormat nanoseconds = BlockTimer::TimeFormat::NANOSECONDS;
    constexpr BlockTimer::TimeFormat microseconds = BlockTimer::TimeFormat::MICROSECONDS;
    constexpr BlockTimer::TimeFormat milliseconds = BlockTimer::TimeFormat::MILLISECONDS;
    constexpr BlockTimer::TimeFormat seconds = BlockTimer::TimeFormat::SECONDS;
